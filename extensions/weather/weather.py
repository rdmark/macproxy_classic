...
def process_html(content):
    ...
    if current_conditions:
        ...
        current_condition = current_conditions.find(
            "p", class_="myforecast-current-lrg"
        )
    ...
    if detailed_forecast:
        detailed_forecast_body = detailed_forecast.find(
            "div", id="detailed-forecast-body"
        )
        if detailed_forecast_body:
            forecast_rows = detailed_forecast_body.find_all(
                "div", class_="row-forecast"
            )
